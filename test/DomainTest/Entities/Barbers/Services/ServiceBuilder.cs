...
internal class ServiceBuilder
{
    ...
    public static Service Build(Guid branchId, TimeSpan duration)
    {
        var faker = new Faker();
        ...
        var service = new Service(branchId, category, faker.Commerce.ProductName(), faker.Lorem.Text(), price, price * (1 - faker.Random.Decimal((decimal)0.1, (decimal)0.99)), faker.Random.Bool(), faker.Random.Bool(), duration);
